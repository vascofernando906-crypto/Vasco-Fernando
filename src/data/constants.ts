...
export const COMPANY_INFO = {
  ...
  facebookUrl: 'https://www.facebook.com/vonamocambique',
  facebookButtonText: 'Facebook Oficial',
  instagramUrl: 'https://www.instagram.com/vonamocambique/',
  instagramButtonText: 'Instagram Oficial',
